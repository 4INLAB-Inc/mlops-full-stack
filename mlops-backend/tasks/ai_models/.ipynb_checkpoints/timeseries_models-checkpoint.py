...
# 2️⃣ OPTUNA OPTIMIZATION FUNCTION (Runs only if model_type="auto")
# ==========================
...
def train_timeseries_model(model, X_train, y_train, X_val, y_val, best_params, epochs=10, patience=10):
    """
