...
def retrieve_metadata_file(model_metadata_file_path: str):
    logger.info(f"Input model_metadata_file_path: {model_metadata_file_path}")
    
    # model_meta_path = os.path.join(CENTRAL_STORAGE_PATH, "models/timeseries/stock_prediction_BiLSTM_ver004", model_metadata_file_path)
...
def tf_load_model(model_metadata_file_path: str):
    ...
    model_dir = os.path.join(CENTRAL_STORAGE_PATH, 'models/timeseries/stock_prediction_BiLSTM_ver004/')
    if not model_dir:
